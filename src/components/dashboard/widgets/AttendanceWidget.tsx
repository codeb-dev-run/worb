...
export function AttendanceWidget({ todayAttendance, workspaceId, userId, onAttendanceUpdate }: AttendanceWidgetProps) {
    ...
    return (
        <>
            <Card
                className="rounded-3xl border-0 shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-lime-400 text-slate-900 hover:-translate-y-1 transition-all duration-300 col-span-1 md:col-span-2 lg:col-span-2 relative overflow-hidden group border border-white/10 cursor-pointer"
                ...
                <CardContent className="p-6 h-[160px] flex flex-col justify-between relative z-10">
                    <div className="flex justify-between items-start">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-slate-800 text-xs font-medium opacity-80">클릭하여 출퇴근 처리</p>
                            </div>
                        </div>
                    ...
                    <div className="grid grid-cols-2 gap-8 mt-2">
                        ...
                        <div>
                            ...
                            <div className="flex items-baseline gap-2">
                                <span className={`text-3xl font-bold tracking-tight text-slate-900 ${!todayAttendance?.checkOut ? 'opacity-50' : ''}`}>
